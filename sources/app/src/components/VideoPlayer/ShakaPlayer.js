...
class ShakaPlayer extends Component {
  ...
  render() {
    ...
    return (
      <div
        id="videoContainer" className="player-container stream-player"
        style={{ margin: '0 auto' }}
      >
        <video
        ...
        <div id="bufferingSpinner" className="overlay">
          <svg className="spinnerSvg" viewBox="25 25 50 50">
            <circle
              className="spinnerPath" cx="50" cy="50" r="20"
        ...
        <div id="controlsContainer" className="overlay">
          <div id="controls">
            <button
              id="playPauseButton" className="material-icons"
              onClick={this.playPause}
            >play_arrow
            </button>
            ...
            <input
              id="seekBar" type="range" step="any" min="0" max="1" defaultValue="0"
            ...
            <button id="muteButton" className="material-icons" onClick={this.muteClick}>volume_up
            </button>
            <label htmlFor="volumeBar" className="for-screen-readers">volume</label>
            <input
              id="volumeBar" type="range" step="any" min="0" max="1" defaultValue="0"
              onInput={this.volumeInput}
            />
            <button
              id="fullscreenButton" className="material-icons"
