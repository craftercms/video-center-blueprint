          ...
          <div id="controlsContainer" className="overlay">
            <div id="controls">
              <button
                ...
                onClick={this.playPause}
              >{playing ? 'pause' : 'play_arrow'}</button>
              <label htmlFor="seekBar" className="for-screen-readers">seek</label>
              <input
                id="seekBar" type="range" step="any" min="0" max="1"
                value={played}
              ...
              <button
                id="muteButton" className="material-icons"
                onClick={this.toggleMuted}
              >{muted ? 'volume_off' : 'volume_up'}</button>
              <label htmlFor="volumeBar" className="for-screen-readers">volume</label>
              <input
                id="volumeBar" type='range' min="0" max="1" step='any' value={volume}
