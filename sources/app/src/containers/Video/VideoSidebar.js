            ...
            <div className="video-sidebar__content-scroll">
              <div className="video-sidebar__content-inner--custom">
                <div className="playlist">
                  <a
                    className="playlist__item playlist__item--playable"
                    href="/video/AP-1QBDNKH9W1W11/andy-noakley-profile?playlist=AP-1PFA8VUKN1W11"
                  >
                      ...
                      <div className="playlist__image">
                        <div className="image">
                          <div
                            ...
                            style={{ backgroundImage: `url("/static-assets/images/videos/6f1b063a-cb5d-6afd-ce79-02972ba88fb9/auditorium-benches-chairs-207691.jpg")` }}
                          ></div>
                        </div>
